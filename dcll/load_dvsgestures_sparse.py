...
dcll_folder = '/home/bibo/Data/DVSgesture/DVS  Gesture dataset'
...
class SequenceGenerator(object):
    def __init__(self,
        filename = os.path.join(dcll_folder, 'dvs_gestures_events.hdf5'),
        group = 'train',
        batch_size = 32,
        chunk_size = 500,
        ds = 2,
...
def create_events_hdf5(hdf5_filename):
    fns_train = gather_aedat(os.path.join(dcll_folder, 'DvsGesture'),1,24)
    fns_test = gather_aedat(os.path.join(dcll_folder, 'DvsGesture'),24,30)
...
# OUT
def create_data(filename = os.path.join(dcll_folder, 'dvs_gestures_events.hdf5'),
